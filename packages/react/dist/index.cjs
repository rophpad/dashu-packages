...
__export(index_exports, {
  BarChart: () => BarChart,
  DashuComposer: () => DashuComposer,
  DashuResult: () => DashuResult,
  LineChart: () => LineChart,
  Metric: () => Metric,
  PieChart: () => PieChart,
...
function Table({ data, maxHeight = 420 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 13 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: data.columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "th",
            {
              scope: "col",
              style: {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: data.rows.map((row, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: data.columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "td",
            {
              style: {
                padding: "7px 12px",
        ...
        data.truncated && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { margin: 0, padding: "8px 12px", fontSize: 12, color: token.faint }, children: [
          "Showing the first ",
...
function Metric({ data, spec }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 12, color: token.muted, marginBottom: 6 }, children: spec.title ?? columnLabel(data, key) }),
...
function BarChart({ points }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "div",
    {
      ...
      children: points.map((point, index) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "div",
        {
...
function LineChart({ points, filled = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { fontFamily: token.font }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: area, fill: token.accent, fillOpacity: filled ? 0.16 : 0.06 }),
          ...
          !filled && coords.map((coord, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "circle",
            {
              cx: coord.x,
              cy: coord.y,
              ...
              stroke: token.panel,
              strokeWidth: 1.5,
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("title", { children: `${coord.label}: ${formatValue(coord.value)}` })
            },
            index
          ))
        ]
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: points[0].label }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { fontFamily: token.mono, fontVariantNumeric: "tabular-nums" }, children: [
            formatValue(min),
            " \u2013 ",
            formatValue(max)
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: points[points.length - 1].label })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "svg",
          {
            ...
            children: [
              ...
              ) : wedges.map((wedge, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "path",
                {
                  ...
                  stroke: token.panel,
                  strokeWidth: 1.5,
                  children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("title", { children: `${wedge.label}: ${formatValue(wedge.value)} (${(wedge.value / total * 100).toFixed(1)}%)` })
                },
                index
              )),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("ul", { style: { flex: 1, minWidth: 0, margin: 0, padding: 0, listStyle: "none" }, children: wedges.map((wedge, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "li",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { flexShrink: 0, fontFamily: token.mono, fontVariantNumeric: "tabular-nums" }, children: formatValue(wedge.value) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                "span",
                {
                  style: {
...
function ScatterChart({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontFamily: token.font }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "svg",
      {
        ...
        children: [
          ...
          coords.map((coord, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("circle", { cx: coord.cx, cy: coord.cy, r: 3, fill: token.accent, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("title", { children: `${xLabel ?? "x"} ${coord.label} \xB7 ${yLabel ?? "y"} ${formatValue(coord.value)}` }) }, index))
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontFamily: token.mono, fontVariantNumeric: "tabular-nums" }, children: formatValue(xMin) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: xLabel ? `${xLabel} \u2192` : "\u2192" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontFamily: token.mono, fontVariantNumeric: "tabular-nums" }, children: formatValue(xMax) })
        ]
      }
    )
  ] });
...
function Display({
  ...
  const points = (0, import_react.useMemo)(() => toPoints(data, spec), [data, spec]);
  const xLabel = columnLabel(data, spec.x);
  const yLabel = columnLabel(data, spec.y);
  switch (spec.type) {
    case "metric":
      return components.Metric ? components.Metric({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Metric, { data, spec });
    case "bar-chart":
      return components.BarChart ? components.BarChart({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(BarChart, { points });
    case "line-chart":
      return components.LineChart ? components.LineChart({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(LineChart, { points });
    case "area-chart":
      return components.AreaChart ? components.AreaChart({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(LineChart, { points, filled: true });
    case "pie-chart":
      return components.PieChart ? components.PieChart({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(PieChart, { points });
    case "scatter-chart":
      return components.ScatterChart ? components.ScatterChart({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ScatterChart, { points, xLabel, yLabel });
    case "table":
    default:
      return components.Table ? components.Table({ data, spec }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Table, { data });
  }
}
function DashuResult({
  ...
  if (!result.answered) {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className, style: { fontFamily: token.font, color: token.muted, fontSize: 14 }, children: result.answer.text });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className, style: { fontFamily: token.font }, children: [
    result.answer.text && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { style: { margin: "0 0 12px", fontSize: 14, lineHeight: 1.5 }, children: result.answer.text }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("figure", { style: { margin: 0 }, children: [
      (active.title || allowSwitching && options.length > 1) && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        "figcaption",
        {
          style: {
            display: "flex",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: 12, fontWeight: 500, color: token.muted }, children: active.title ?? "" }),
            allowSwitching && options.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "span",
              {
                style: {
                  display: "inline-flex",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Display, { data, spec: active, components })
    ] }),
    showSql && result.query && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("details", { style: { marginTop: 12, fontSize: 12 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("summary", { style: { cursor: "pointer", color: token.muted }, children: [
        "Generated ",
...
function DashuComposer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className, style: { fontFamily: token.font }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("form", { onSubmit: submit, style: { display: "flex", gap: 8 }, children: [
      ...
      loading && onCancel ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        "button",
        {
          type: "button",
          onClick: onCancel,
    ...
    !value && suggestions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginTop: 10 }, children: suggestions.map((suggestion) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "button",
      {
        type: "button",
...
function useDashu(options = {}) {
  ...
  const controller = (0, import_react3.useRef)(null);
  const lastQuestion = (0, import_react3.useRef)("");
  ...
  return {
    ask: send,
    retry: (0, import_react3.useCallback)(() => send(lastQuestion.current), [send]),
    cancel,
    reset,
    result,
    error,
